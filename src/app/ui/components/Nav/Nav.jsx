      ...
      <AppBar position="fixed" className={classes.appBar} elevation={0}  >
        <Toolbar  >
          ...
          <Grid container spacing={1} className={classes.iconsContainer}>
            <Grid item sm={3} >
              <RLink to="/">
                <IconButton variant="contained" color={activeMode === 'home'?"primary":" "}>
            ...
            <Grid item sm={3}>
              <RLink to="/connections">
                <IconButton variant="contained" color={activeMode === 'connections'?"primary":" "}>
            ...
            <Grid item sm={3}>
              <RLink to="/messages">
                <IconButton variant="contained" color={activeMode === 'messages'?"primary":" "}>
            ...
            <Grid item sm={3}>
              <RLink to="/notifications">
                <IconButton variant="contained" color={activeMode === 'notifications'?"primary":" "}>
