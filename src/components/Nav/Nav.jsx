...
const IconLink = (props) => {
  ...
  const color = props.children.props.color;
  return (
    <RLink
      {...props}
      className={`
    ...
    >
      {props.children}
      <span className={color === 'primary' ? classes.primaryColor : ''}>
        {props.name}
      </span>
    </RLink>
  )
          ...
          <Grid container spacing={1} className={classes.iconsContainer}>
            <Grid item sm={3} >
              <IconLink to="/" name="Home">
                <IconButton variant="contained" color={activeMode === 'home' ? "primary" : "default"}>
            ...
            <Grid item sm={3}>
              <RLink to="/connections">
                <IconButton variant="contained" color={activeMode === 'connections' ? "primary" : "default"}>
            ...
            <Grid item sm={3}>
              <RLink to="/messages">
                <IconButton variant="contained" color={activeMode === 'messages' ? "primary" : "default"}>
            ...
            <Grid item sm={3}>
              <RLink to="/notifications">
                <IconButton variant="contained" color={activeMode === 'notifications' ? "primary" : "default"}>
